                  ...
                  <div class="form-panel">
                      ...
                      ?>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input type="text" name="rin_nombre" class="form-control" id="rin_nombre" placeholder="Nombre de la Propiedad" required="" autofocus="" maxlength="250" value="<?php echo set_value('rin_nombre'); ?>">
                              </div>
                          </div>  
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input type="text" name="rin_numero" class="form-control" id="rin_numero" placeholder="Número reservas al día por usuario" required="" maxlength="4" value="<?php echo set_value('rin_numero'); ?>">
                              </div>
                          </div>                                                   
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input type="text" name="rin_antelacion" class="form-control" id="rin_antelacion" placeholder="Días de Antelación" required="" value="<?php echo set_value('rin_antelacion'); ?>">
                              </div>
                          </div>
                          <div class="form-group">
                              <label for="rin_anulacion" class="col-sm-2 col-sm-2 control-label">Horas de Anulación</label>
                              <div class="col-sm-10">
                                <input type="text" name="rin_anulacion" class="form-control" id="rin_anulacion" placeholder="Horas de Anulación" required="" maxlength="4" value="<?php echo set_value('rin_anulacion'); ?>">
                              </div>
                          </div>
                          <div class="form-group">
                              <div class="col-lg-12">
