      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
            <h3><i class="fa fa-angle-right"></i> Administradores</h3>
            <div class="row mt">
              <div class="col-lg-12">
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <div class="btn-group">
                                    ...
                                    <a title="Borrar" onclick="return confirm('¿Desea eliminar el registro?')" href="<?php echo site_url($this->controller.'/delete/'.$r['rus_id']); ?>" class="btn btn-danger"><i class="fa fa-remove"></i></a>
                                  </div>
                                  <?php } ?>
                                </td>
                              </tr>
